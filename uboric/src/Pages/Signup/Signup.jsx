  ...
  return (
    <>
      <div>
        ...
        {/* MAIN PAGE */}
        <h3 style={{ color: "#06283D" }}>My account</h3>
        <h3 style={{ color: "#06283D" }}>Home {">"} My account</h3>
        <div className="s">
          {/* login page */}
          <div className="L">
            <h1>Login</h1>
            ...
            <a href="https://accounts.google.com/o/oauth2/auth/identifier?redirect_uri=https%3A%2F%2Fwww.uboric.com%2Fopenidcallback%2Fgoogle&response_type=code&client_id=828138456133-oc1gbhasijnadbs14fi9p898c1abb3he.apps.googleusercontent.com&scope=email%20profile&access_type=offline&flowName=GeneralOAuthFlow">
              {" "}
              <img
            ...
            <p
              style={{ marginLeft: "53%", marginTop: "50px", color: "#06283D" }}
            >
              {" "}
              <a href="https://www.uboric.com/my-account/lost-password/">
                Lost your password ?
              </a>
            </p>
          </div>
          ...
          <div className="L">
            ...
            <b>
              {" "}
              <p>
                Creating an account is quick and easy, and will allow you to
                move through our checkout quicker.
              </p>
            </b>
            <b>
              {" "}
